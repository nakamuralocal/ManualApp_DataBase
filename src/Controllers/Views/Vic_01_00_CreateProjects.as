package Controllers.Views
{
	...
	public class Vic_01_00_CreateProjects implements IMXMLObject
	{
		public function Vic_01_00_CreateProjects()
		{
		}
		
		public function initialized(document:Object, id:String):void
		{
			view = document as Viw_01_00_CreateProjects;
			view.addEventListener(FlexEvent.CREATION_COMPLETE , complete_CreationView);
		}
		
		private var view:Viw_01_00_CreateProjects;
		...
		private function complete_CreationView(evt:FlexEvent):void
		{
			...
			view.prs_NewTable.viewCon.startUp_NewMode(Sta_UseViews.LABEL_00_00);
		}
